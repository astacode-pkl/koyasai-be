                        ...
                        <tbody class="">
                            @foreach ($loghistories as $loghistory)
                                <tr id="{{ $loop->iteration }}" class="gradeC">
                                    ...
                                    <td>{{ !empty($loghistory->properties['old']) ? json_encode($loghistory->properties['old']) : '-' }}</td>
                                    <td>{{ !empty($loghistory->properties['attributes']) ? json_encode($loghistory->properties['attributes']) : '-' }}</td>
                                    <td>
