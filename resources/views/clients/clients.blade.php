            ...
            <div class="card-body">
                <div class="mb-2">
                    <div class="d-flex justify-content-between align-content-center">
                        ...
                        <a href="/clients/create"><button class="btn btn-primary"> <i class="ti ti-plus "></i>
                                Create</button> </a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($clientss as $client)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/clients/{{ Crypt::encryptString($client->id) }}/edit"
                                                class="btn btn-warning  px-4 waves-effect waves-light">
                                                <i class="ti ti-edit "></i> Edit
                                            </a>
                                            </button>
                                            <form action="/clients/{{ Crypt::encryptString($client->id) }}"
